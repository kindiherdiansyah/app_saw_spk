  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <!-- /.box-header -->
        <form action="proses.php?aksi=tambah&data=tarif" method="POST">
          <div class="box-body">
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <?php 
                  $result = mysqli_query($konek, "SELECT id FROM tbl_tarif ORDER BY id DESC LIMIT 1");
                  $idP = mysqli_fetch_array($result);
                  $idP = $idP['id']+1;
                  ?>
                  <input type="text" class="form-control" name="id_tarif" value="A0<?=$idP?>" >
                </div>
                <div class="form-group">
                  <label>Tarif</label>
